                ...
                <div className="sticky top-0 z-10 bg-gradient-to-b from-[#fcfcfc] to-[#f9fafb] border-y border-[#e6e6e6]">
                  <div className="p-2.5 flex flex-wrap items-center gap-1.5">
                    ...
                    <div className="flex gap-1 bg-white border border-[#e6e6e6] rounded-[12px] p-1.5 shadow-[0_1px_4px_rgba(0,0,0,0.04)]">
                      ...
                      <button type="button" title="Strikethrough" onClick={() => editor.chain().focus().toggleStrike().run()} className={`w-8 h-8 rounded-[8px] flex items-center justify-center transition-colors ${isActive('strike') ? 'bg-[#111827] text-white shadow-sm' : 'hover:bg-[#f6f5f4] text-[#374151]'}`}><Highlighter size={14} /></button>
                    ...
                    <div className="flex gap-1 bg-white border border-[#e6e6e6] rounded-[12px] p-1.5 shadow-[0_1px_4px_rgba(0,0,0,0.04)] items-center">
                      <div className="hidden lg:flex items-center gap-1.5 px-2 border-r border-[#e6e6e6] mr-1">
                        ...
                        <select value={getHeadingLevel()} onChange={e => { const v = e.target.value; if (v === 'p') editor.chain().focus().setParagraph().run(); else editor.chain().focus().toggleHeading({ level: Number(v) as any }).run(); }} className="h-8 text-xs font-medium border-0 bg-transparent pr-2 focus:ring-0 focus:outline-none cursor-pointer">
                    ...
                    <div className="flex gap-1 bg-white border border-[#e6e6e6] rounded-[12px] p-1.5 shadow-[0_1px_4px_rgba(0,0,0,0.04)] ml-auto">
                      <select value={pageSize} onChange={e => setPageSize(e.target.value as any)} className="h-8 text-xs border-0 bg-transparent pr-1 focus:ring-0 cursor-pointer">
                      ...
                      <span className="w-px h-4 bg-[#e6e6e6] mx-1 self-center" />
                      <button onClick={() => setZoom(Math.max(60, zoom - 10))} className="w-7 h-8 rounded hover:bg-[#f6f5f4] flex items-center justify-center text-[#6b7280]"><ZoomOut size={12} /></button>
                      <span className="text-xs font-mono w-10 text-center">{zoom}%</span>
                      <button onClick={() => setZoom(Math.min(140, zoom + 10))} className="w-7 h-8 rounded hover:bg-[#f6f5f4] flex items-center justify-center text-[#6b7280]"><ZoomIn size={12} /></button>
                      <button onClick={() => setZoom(90)} className="px-1.5 h-8 rounded hover:bg-[#f6f5f4] text-[11px] text-[#6b7280]"><Maximize2 size={12} /></button>
                    </div>
                  </div>
                      ...
                      <div className="p-4 space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          <div className="bg-white border border-[#e6e6e6] rounded-[12px] p-3 shadow-[0_1px_6px_rgba(0,0,0,0.04)]">
                            <div className="flex items-center gap-2 mb-3"><div className="w-8 h-8 rounded-[8px] bg-[#eff6ff] border border-[#dbeafe] text-[#0075de] flex items-center justify-center"><Rows3 size={13} /></div><span className="text-xs font-bold text-[#111]">Baris</span><Badge variant="secondary" className="ml-auto text-[10px]">Rows</Badge></div>
                        ...
                        <div className="bg-white border border-[#e6e6e6] rounded-[12px] p-3 shadow-[0_1px_6px_rgba(0,0,0,0.04)]">
                          <div className="flex items-center gap-2 mb-3"><div className="w-8 h-8 rounded-[8px] bg-amber-50 border border-amber-100 text-amber-600 flex items-center justify-center"><Layers size={13} /></div><span className="text-xs font-bold text-[#111]">Aksi Tabel</span><span className="text-[11px] text-[#6b7280] hidden sm:inline">— pilih cell lalu eksekusi</span><button type="button" onClick={() => { editor.chain().focus().deleteTable().run(); showToast('Tabel dihapus', 'info') }} className="ml-auto h-7 px-3 text-xs font-medium bg-red-600 text-white rounded-[8px] hover:bg-red-700 flex items-center gap-1.5"><Trash2 size={12} /> Hapus Tabel</button></div>
                        ...
                        <div className="grid grid-cols-1 xl:grid-cols-2 gap-3">
                          <div className="bg-white border border-[#e6e6e6] rounded-[12px] p-3 shadow-[0_1px_6px_rgba(0,0,0,0.04)] space-y-3">
                            <div className="flex items-center gap-2"><div className="w-8 h-8 rounded-[8px] bg-emerald-50 border border-emerald-100 text-emerald-600 flex items-center justify-center"><Brush size={13} /></div><span className="text-xs font-bold text-[#111]">Gaya Cell</span><Badge variant="outline" className="ml-auto text-[10px]">Cell</Badge></div>
