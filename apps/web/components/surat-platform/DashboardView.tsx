...
export default function DashboardView() {
  ...
  return (
    <PageShell
      ...
      actions={
        <>
          <Link href="/components-persuratan/new"><Button><Boxes size={16} /> Buat Component</Button></Link>
          <Link href="/templates-persuratan/new"><Button variant="outline"><FileStack size={16} /> Buat Template</Button></Link>
        </>
      }
    ...
    >
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-base"><Layers size={16} className="text-[#0075de]" /> Alur Persuratan (4 Langkah)</CardTitle>
        ...
        <CardContent>
          <div className="grid md:grid-cols-4 gap-4">
            <div className="rounded-[12px] border border-[#e6e6e6] p-4 bg-[#fafafa]">
              <div className="w-8 h-8 rounded-[8px] bg-[#0075de] flex items-center justify-center text-white mb-3"><Boxes size={16} /></div>
              <div className="text-sm font-bold">1. Component</div>
            ...
            <div className="rounded-[12px] border border-[#e6e6e6] p-4 bg-[#fafafa]">
              <div className="w-8 h-8 rounded-[8px] bg-violet-600 flex items-center justify-center text-white mb-3"><FileStack size={16} /></div>
              <div className="text-sm font-bold">2. Template Builder</div>
            ...
            <div className="rounded-[12px] border border-[#e6e6e6] p-4 bg-[#fafafa]">
              <div className="w-8 h-8 rounded-[8px] bg-amber-500 flex items-center justify-center text-white mb-3"><ClipboardList size={16} /></div>
              <div className="text-sm font-bold">3. Administrasi</div>
            ...
            <div className="rounded-[12px] border border-[#e6e6e6] p-4 bg-[#fafafa]">
              <div className="w-8 h-8 rounded-[8px] bg-emerald-500 flex items-center justify-center text-white mb-3"><Files size={16} /></div>
              <div className="text-sm font-bold">4. Hasil Surat</div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <CardTitle className="text-sm flex items-center gap-2"><FileStack size={14} className="text-violet-600" /> Templates Persuratan Terbaru</CardTitle>
            <Link href="/templates-persuratan" className="text-xs text-[#0075de] font-medium hover:underline">Lihat semua →</Link>
          </CardHeader>
          <CardContent className="space-y-3">
            {recentTemplates.length === 0 ? <div className="text-xs text-[#6b7280] py-6 text-center">Belum ada template persuratan</div> : recentTemplates.map((t) => (
              <div key={t.id} className="flex items-center gap-3 p-3 rounded-[8px] border border-[#e6e6e6] hover:bg-[#f6f5f4] transition-colors">
                <div className="w-9 h-9 rounded-[8px] bg-violet-50 flex items-center justify-center text-violet-600"><FileStack size={16} /></div>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <CardTitle className="text-sm flex items-center gap-2"><Files size={14} className="text-emerald-600" /> Hasil Persuratan Terbaru</CardTitle>
            <Link href="/hasil-persuratan" className="text-xs text-[#0075de] font-medium hover:underline">Lihat semua →</Link>
          </CardHeader>
          <CardContent className="space-y-3">
            {recentHasil.length === 0 ? <div className="text-xs text-[#6b7280] py-6 text-center">Belum ada hasil persuratan</div> : recentHasil.map((d) => (
        ...
        <CardContent className="p-6">
          <div className="flex flex-col md:flex-row gap-6 items-start">
            ...
            <div className="flex-1">
              <div className="text-sm font-bold">Coba langsung — Template Persuratan Tiptap!</div>
