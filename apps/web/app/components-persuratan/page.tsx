...
export default function ComponentsPersuratanPage(){
  ...
  return (
    <PageShell title="Component Persuratan" description="Kelola komponen — buat, pratinjau, dan hapus. Editor mendukung pengulangan dan penyisipan data." breadcrumbs={[{label:"Persuratan"},{label:"Components"}]} actions={<Link href="/components-persuratan/new"><Button><Plus size={16}/> Buat Component</Button></Link>}>
